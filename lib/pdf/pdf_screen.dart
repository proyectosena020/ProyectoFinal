                ...
                pw.Row(
                  ...
                  children: [
                    pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                        children: [
                          pw.Text(texts.pdf.nombre_del_sitio(name: lugar),
                              style: const pw.TextStyle(fontSize: 13)),
                          pw.Text(
                              texts.pdf
                                  .nombre_del_cliente(name: nombreCompleto),
                              style: const pw.TextStyle(fontSize: 13)),
                          pw.Text(texts.pdf.telefono(name: telefono),
                              style: const pw.TextStyle(fontSize: 13)),
                          pw.Text(
                              '${texts.pdf.documento(name: tipodocumento)} $numeroDocumento',
                              style: const pw.TextStyle(fontSize: 13)),
                    ...
                    pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
                        pw.Text(texts.pdf.information,
                            style: const pw.TextStyle(fontSize: 13)),
                        UrlText('STAYAWAY',
                            texts.pdf.telefono(name: 222 - 233 - 445 - 556),
