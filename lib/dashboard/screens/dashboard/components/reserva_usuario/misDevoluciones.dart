  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            texts.reservas_todo.misDevoluciones.title,
      ...
      cells: [
        ...
        DataCell(FutureBuilder(
            ...
            builder: (context, AsyncSnapshot<List<UsuariosModel>> usuario1) {
              ...
              for (var v = 0; v < usuario1.data!.length; v++) {
                if (misDevolucionesInfo.reserva.usuario ==
                    usuario1.data![v].id) {
        ...
        DataCell(
          FutureBuilder<String>(
            future: traduccionVariables(context, misDevolucionesInfo.estado),
              ...
              return IconButton(
                  onPressed: () {
                    ...
                    pedido = "$pedido "
                        ...
                        "\n ${texts.reservas_todo.totalDevoluciones.summery.nameSite(name: misDevolucionesInfo.reserva.sitio.titulo)}\n"
                        " ${texts.reservas_todo.totalDevoluciones.summery.location(name: misDevolucionesInfo.reserva.sitio.lugar)} \n"
                        " ${texts.reservas_todo.totalDevoluciones.summery.checkInDate(name: misDevolucionesInfo.reserva.fechaEntrada)} \n"
                        " ${texts.reservas_todo.totalDevoluciones.summery.checkOut(name: misDevolucionesInfo.reserva.fechaSalida)} \n"
                        " ${texts.reservas_todo.totalDevoluciones.summery.filingDate(name: misDevolucionesInfo.fechaRadicado)}\n"
                        " ${texts.reservas_todo.totalDevoluciones.summery.paymentDate(name: misDevolucionesInfo.fechaPago)}\n"
                        " ${texts.reservas_todo.totalDevoluciones.summery.total(name: misDevolucionesInfo.reserva.numHuespedes)} \n"
                        " ${texts.reservas_todo.totalDevoluciones.summery.totalPrice(name: misDevolucionesInfo.reserva.precioFinal)}";
