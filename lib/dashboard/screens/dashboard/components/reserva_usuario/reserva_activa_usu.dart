...
import 'package:proyecto_final/dashboard/screens/dashboard/components/reserva_usuario/cancelacionReserva.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            texts.reservas_todo.misReservasActivas.title,
    ...
    cells: [
      ...
      DataCell(ElevatedButton(
        onPressed: () {
          ...
          _modalCancelarReserva(context, reservaAInfo, themeManager);
        },
        style: const ButtonStyle(
            backgroundColor: MaterialStatePropertyAll(primaryColor)),
          ...
          builder: (context, AsyncSnapshot<List<UsuariosModel>> usuario1) {
            ...
            return IconButton(
                onPressed: () {
                  ...
                  String pedido = "";
                  pedido = "$pedido "
                      "${texts.reservas_todo.misReservasActivas.summery.text1} "
                      "${texts.reservas_todo.misReservasActivas.summery.nameSite(name: reservaAInfo.sitio.titulo)}\n"
                      "${texts.reservas_todo.misReservasActivas.summery.location(name: reservaAInfo.sitio.lugar)} \n"
                      "${texts.reservas_todo.misReservasActivas.summery.checkInDate(name: reservaAInfo.fechaEntrada)} \n"
                      "${texts.reservas_todo.misReservasActivas.summery.checkOut(name: reservaAInfo.fechaSalida)} \n"
                      "${texts.reservas_todo.misReservasActivas.summery.total(name: reservaAInfo.numHuespedes)} \n"
                      "${texts.reservas_todo.misReservasActivas.summery.totalPrice(name: reservaAInfo.precioFinalFormatted)}";
