...
class ReservaFinalizadaT extends StatefulWidget {
  ...
  @override
  State<ReservaFinalizadaT> createState() => _ReservaFinalizadaTState();
}

class _ReservaFinalizadaTState extends State<ReservaFinalizadaT> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            texts.reservas_todo.reservas_finalizadas.title,
            style: Theme.of(context).textTheme.titleMedium,
          ),
          FutureBuilder(
              future: getReservas(), // llama todas las reservas
              builder:
                  (context, AsyncSnapshot<List<ReservaModel>> reservaFinal) {
                // Mientras carga la información
                if (reservaFinal.connectionState == ConnectionState.waiting) {
                  return const Center(
                ...
                if (reservaFinal.data != null) {
                  // Verifica si hay reservas finalizadas
                  for (var r = 0; r < reservaFinal.data!.length; r++) {
                    if (reservaFinal.data![r].estado == "Finalizado") {
...
DataRow ReservaFtDataRow(ReservaModel reservaFInfo, BuildContext context) {
