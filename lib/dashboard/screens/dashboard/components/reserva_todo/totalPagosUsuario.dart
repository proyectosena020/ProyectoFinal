...
class PagosTotal extends StatefulWidget {
  const PagosTotal({
    Key? key,
  }) : super(key: key);

  @override
  State<PagosTotal> createState() => _PagosTotalState();
}

class _PagosTotalState extends State<PagosTotal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            texts.reservas_todo.usuarioTotalPago.title,
                    ...
                    return IconButton(
                        ...
                        onPressed: () {
                          ...
                          pedido =
                              ...
                              " \n ${texts.reservas_todo.usuarioTotalPago.summery.nameSite(name: PagosInfo.reserva.sitio.titulo)}\n "
                              "${texts.reservas_todo.usuarioTotalPago.summery.location(name: PagosInfo.reserva.sitio.lugar)} \n "
                              "${texts.reservas_todo.usuarioTotalPago.summery.checkInDate(name: PagosInfo.reserva.fechaEntrada)} \n "
                              "${texts.reservas_todo.usuarioTotalPago.summery.checkOut(name: PagosInfo.reserva.fechaSalida)} \n "
                              "${texts.reservas_todo.usuarioTotalPago.summery.paymentMethod(name: snapshot.data!)}\n "
                              "${texts.reservas_todo.usuarioTotalPago.summery.paymentDate(name: PagosInfo.fechaPago)}\n "
                              "${texts.reservas_todo.usuarioTotalPago.summery.total(name: PagosInfo.reserva.numHuespedes)} "
                              "${texts.reservas_todo.usuarioTotalPago.summery.totalPrice(name: PagosInfo.reserva.precioFinal)}";
