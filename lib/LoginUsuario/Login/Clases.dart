  ...
  Future logIn() async {
    if (UniversalPlatform.isAndroid || UniversalPlatform.isIOS) {
      ...
      if (isAvailable && isDeviceSupported) {
        bool result = await auth.authenticate(localizedReason: texts.huella2);
            ...
            showDialog<void>(
                ...
                builder: (BuildContext dialogContext) {
                  return AlertDialog(
                    ...
                    content: Text(texts
                        .identificacionClases.error_al_verificar_credenciales),
                    actions: <Widget>[
                      ButtonBar(
                                ...
                                child: Row(
                                  children: [
                                    TabBar(
                                      ...
                                      tabs: [
                                        Tab(text: texts.clases.singnIn),
                                        Tab(
                                          text: texts.clases.singUp,
                                        ),
                                      ],
                                    ),
                                  ],
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText:
                                              texts.identificacionClases.pass,
                                          hintStyle: const TextStyle(
                                              color: Colors.black),
                                          filled: true,
                                        ),
      ...
      Expanded(
          ...
          child: CupertinoButton(
            ...
            if (formKey.currentState!.validate()) {
                 //Si todos los campos están completos, continúa con la lógica de avanzar a la siguiente página
                if (currentIndex == listaVistas.length - 1) {
                  validacionColor; //color
                  if (porcentaje == 1) {
                    signIn(); // Avanza a la función de registro si el porcentaje es 1
                  }
                }
