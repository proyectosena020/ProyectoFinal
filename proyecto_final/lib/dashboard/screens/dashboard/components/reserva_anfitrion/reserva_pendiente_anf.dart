  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Reservas pendientes de mis sitios",
          ...
          SizedBox(
            ...
            child: InteractiveViewer(
              ...
              child: DataTable(
                ...
                rows: List.generate(
                  demoReservaAnfP.length,
                  (index) => ReservaPaDataRow(demoReservaAnfP[index], context),
                ),
              ),
            ),
          ),
...
DataRow ReservaPaDataRow(ReservaAnfPend reservaPInfo, BuildContext context) {
