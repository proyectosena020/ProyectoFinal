...
class _SitioAnfCardState extends State<SitioAnfCard> {
  ...
  // Definir una variable para almacenar el índice actual
  ...
  GlobalKey<FormState> keyEditSitio = GlobalKey<FormState>();
                                                  ...
                                                  Padding(
                                                    padding:
                                                        const EdgeInsets.only(
                                                            top: 2, left: 10),
                                                    child: Text(
                                                      "\$ ${texts.mySites.noche(name: widget.sitio.valorNocheFormatted)}",
                                                      style: const TextStyle(
                                                        fontSize: 12,
                                                        fontWeight:
                                                            FontWeight.normal,
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => Form(
                                          key: keyEditSitio,
                                          child: FormActualizarSitio(
                                            sitio: widget.sitio,
                                            themeManager: widget.themeManager,
                                            keyEditSitio: keyEditSitio,
                                          ))),
                                );
                              },
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Center(
                      child: Text(
                        texts.mySites.question.contenedor,
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Center(
                      child: Text(
                        texts.mySites.question3.contenedor,
                        style: const TextStyle(color: Colors.grey),
                        textAlign: TextAlign.center,
                      ),
                    ),
