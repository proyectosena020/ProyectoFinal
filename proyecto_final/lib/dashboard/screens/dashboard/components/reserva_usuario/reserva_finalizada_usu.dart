...
class ReservaFinalizadaU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List ReservaUsuFinalList = [
      ReservaUsuFinalModel(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            texts.reservationsCompleted.myReservationsCompleted,
          ...
          SizedBox(
            ...
            child: InteractiveViewer(
              ...
              child: DataTable(
                ...
                rows: List.generate(
                  ReservaUsuFinalList.length,
                  (index) => ReservaFuDataRow(ReservaUsuFinalList[index], context),
                ),
              ),
            ),
          ),
...
DataRow ReservaFuDataRow(ReservaUsuFinalModel reservaFInfo, BuildContext context) {
  bool isDark = Theme.of(context).brightness == Brightness.dark;
  final texts = Translations.of(context);
  return DataRow(
    cells: [
