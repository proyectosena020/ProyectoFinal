  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            texts.reservas_todo.misReservasCanceladas.title,
                        ...
                        for (var u = 0; u < usuario.data!.length; u++) {
                          ...
                          if (FirebaseAuth.instance.currentUser!.email ==
                            ...
                            for (var r = 0; r < reserva.data!.length; r++) {
                              // Verifica si el usuario tiene reservas canceladas
                              if (reserva.data![r].usuario ==
                                  usuario.data![u].id) {
                                if (reserva.data![r].estado == "Cancelado") {
                                  reservaCancelada.add(reserva.data![r]);
                                }
                              }
                            }
                          }
...
DataRow ReservaCuDataRow(ReservaModel reservaCInfo, BuildContext context) {
          ...
          builder: (context, AsyncSnapshot<List<UsuariosModel>> usuario1) {
            ...
            return IconButton(
                onPressed: () {
                  ...
                  String pedido = "";
                  pedido = "$pedido "
                      "${texts.reservas_todo.misReservasCanceladas.summery.text1} "
                      "${texts.reservas_todo.misReservasCanceladas.summery.nameSite(name: reservaCInfo.sitio.titulo)}\n"
                      "${texts.reservas_todo.misReservasCanceladas.summery.location(name: reservaCInfo.sitio.lugar)} \n"
                      "${texts.reservas_todo.misReservasCanceladas.summery.checkInDate(name: reservaCInfo.fechaEntrada)} \n"
                      "${texts.reservas_todo.misReservasCanceladas.summery.checkOut(name: reservaCInfo.fechaSalida)} \n"
                      "${texts.reservas_todo.misReservasCanceladas.summery.total(name: reservaCInfo.numHuespedes)} \n"
                      "${texts.reservas_todo.misReservasCanceladas.summery.totalPrice(name: reservaCInfo.precioFinalFormatted)}";
