          ...
          builder: (context, AsyncSnapshot<List<UsuariosModel>> usuario1) {
            ...
            return IconButton(
                onPressed: () {
                  ...
                  String pedido = "";
                  pedido =
                      "$pedido Usted tiene una reserva cancelada con la siguiente información: \n Nombre del Sitio: ${reservaCInfo.sitio.titulo}\n Ubicación: ${reservaCInfo.sitio.lugar} \n Fecha de Entrada: ${reservaCInfo.fechaEntrada} \n Fecha de Salida: ${reservaCInfo.fechaSalida} \n Total de Huespedes: ${reservaCInfo.numHuespedes} \n Total precio de la estadia: ${reservaCInfo.precioFinalFormatted}";
