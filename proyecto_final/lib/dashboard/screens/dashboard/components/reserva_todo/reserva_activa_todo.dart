          ...
          SizedBox(
            ...
            child: InteractiveViewer(
              ...
              child: DataTable(
                ...
                rows: List.generate(
                  demoReservaTodoA.length,
                  (index) => ReservaAtDataRow(demoReservaTodoA[index], context),
                ),
              ),
            ),
          ),
...
DataRow ReservaAtDataRow(ReservaTodoActiva reservaAInfo, BuildContext context) {
