...
import 'package:proyecto_final/login/Screen/Clases.dart';
...
class LoginPage extends StatefulWidget {
  ...
  LoginPage({Key? key, required this.themeManager}) : super(key: key);

  @override
  State<LoginPage> createState() => _LoginPageState(themeManager: themeManager);
}
...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  _LoginPageState({required this.themeManager});
