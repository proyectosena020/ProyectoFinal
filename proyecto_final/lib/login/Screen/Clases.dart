...
class Login extends StatefulWidget {
  ...
  State<Login> createState() =>
      _LoginState(tabController: tabController, themeManager: themeManager);
}

class _LoginState extends State<Login> with SingleTickerProviderStateMixin {
  final ThemeManager themeManager;
  late TabController tabController;
  _LoginState({required this.tabController, required this.themeManager});
...
class Register extends StatefulWidget {
  ...
  Register({Key? key, required this.themeManager}) : super(key: key);

  @override
  State<Register> createState() => _RegisterState(themeManager: themeManager);
}

class _RegisterState extends State<Register> {
  ThemeManager themeManager;

  _RegisterState({required this.themeManager});
                    ...
                    if (porcentaje == 1) {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => MultiProvider(
                          ...
                          child: MainScreenTodo(themeManager: themeManager),
                        ),
                      ));
                    }
                  }
