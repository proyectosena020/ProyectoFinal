...
class IdentificacionWeb extends StatefulWidget {
  // propiedades las cuales reciben los datos para hacer el login
  final ThemeManager themeManager;

  final String email;
  final String contrasena;

  const IdentificacionWeb(
      {Key? key,
  ...
  @override
  State<IdentificacionWeb> createState() =>
      _IdentificacionWebState(themeManager);
}

class _IdentificacionWebState extends State<IdentificacionWeb>
