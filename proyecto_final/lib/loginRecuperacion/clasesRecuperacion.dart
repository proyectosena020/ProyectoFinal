    ...
    try {
      ...
      showDialog<void>(
          ...
          builder: (BuildContext dialogContext) {
            return AlertDialog(
              title: Text(texts.cosas_faltantes.alert.title),
              content:
                  Text(texts.cosas_faltantes.alert.text(email: cuentaEmail)),
              actions: <Widget>[
                ButtonBar(
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    texts.cosas_faltantes.alert.title,
                                ...
                                Center(
                                  child: Padding(
                                    padding: const EdgeInsets.only(
                                        left: 25, right: 30),
                                    child: Text(
                                      texts.cosas_faltantes.alert.text2,
                                      style: const TextStyle(
                                          fontSize: 17, color: Colors.white
                                          //fontFamily: 'DelaGothicOne'
                                          ),
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        texts.cosas_faltantes.alert.text3,
                                        style: const TextStyle(
                                          color: Colors.black,
